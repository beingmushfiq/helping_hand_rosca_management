...
export const CrownIcon: React.FC<IconProps> = ({ className = 'w-6 h-6' }) => (
  <svg xmlns="http://www.w3.org/2000/svg" className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    <path d="M2 4l3 12h14l3-12-6 7-4-7-4 7-6-7zm0 0L5 2h14l3 2" />
  </svg>
);
...
export const PartyPopperIcon: React.FC<IconProps> = ({ className = 'w-6 h-6' }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        <path d="M5.3 18.7l1.4-1.4" />
        <path d="M9 13.3l1.4-1.4" />
        <path d="M14.7 18.7l-1.4-1.4" />
        <path d="M9 17.7l-1.4 1.4" />
        <path d="M13.4 13.3l-1.4 1.4" />
        <path d="M18.7 5.3l-1.4 1.4" />
        <path d="M18.7 9.3l-1.4-1.4" />
        <path d="M22 13.3L12 3 2 13.3a8 8 0 1011.3 8.3c.3 0 .5-.2.5-.5v-3.8c0-.3.2-.5.5-.5h2c.3 0 .5.2.5.5v3.8c0 .3.2.5.5.5A8 8 0 1022 13.3z" />
    </svg>
);
